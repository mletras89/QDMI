...
int QDMI_query_operation_property_double_list(const QDMI_Operation operation,
...
int QDMI_query_operation_property_float_list(const QDMI_Operation operation,
                                             const QDMI_Operation_Property prop,
                                             float **value, int *size) {
  return QDMI_ERROR_NOT_IMPLEMENTED;
}

int QDMI_query_operation_property_int_list(const QDMI_Operation operation,
                                           const QDMI_Operation_Property prop,
                                           int **value, int *size) {
  return QDMI_ERROR_NOT_IMPLEMENTED;
}
